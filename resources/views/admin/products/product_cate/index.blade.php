    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group">
                @can('products.cate.create')
                    <a class="layui-btn layui-btn-sm" href="{{ route('admin.products_cate.create') }}">添 加</a>
                @endcan
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="options">
                <div class="layui-btn-group">
                    ...
                    @endcan
                    @can('products.cate.edit')
                        <a class="layui-btn layui-btn-sm" lay-event="edit">编辑</a>
                    @endcan
                    @can('products.cate.destroy')
        ...
        <script>
            layui.use(['layer','table','form'],function () {
                ...
                var dataTable = table.render({
                    elem: '#dataTable'
                    ,height: 500
                    ,url: "{{ route('admin.products_cate.data',['parent_id'=>request()->input('parent_id',0)]) }}" //数据接口
                    ,page: true //开启分页
                    ,cols: [[ //表头
                ...
                table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if(layEvent === 'del'){
                        layer.confirm('确认删除吗？', function(index){
                            $.post("{{ route('admin.products_cate.destroy') }}",{_method:'delete',ids:data.id},function (result) {
                                if (result.code==0){
                        ...
                        location.href = '/admin/products/category/'+data.id+'/edit';
