...
layui.define(['layer', 'laytpl', 'form', 'element', 'upload', 'util'], function(exports){
    ...
    ,kfcont: function(){
      var html = '';
          html += '\n' +
              ...
              '                <img src="/static/home/images/icon/rticos1.png" alt="QQ客服" height="36" width="36">联系QQ客服\n' +
              '            </a>\n' +
              '        </span>\n' +
              '      <span>\n' +
              '          <a href="#" target="blank" rel="nofollow" title="智能客服">\n' +
              '              <img src="/static/home/images/icon/rticos2.png" alt="智能客服" height="36" width="36">联系智能客服\n' +
              '          </a>\n' +
              '      </span>\n' +
              '    </div>\n' +
              '    <div class="ewm">\n' +
              '      <i><img src="/static/home/images/icon/kfico.png" width="120" alt="72ppt二维码"></i>\n' +
  ...
  //签到
  var tplSignin = ['{{# if(d.status){ }}'
    ,'<button class="layui-btn layui-btn-disabled">今日已签到</button>'
    ,'<span>获得了<cite>{{ d.change }}</cite>积分</span>'
  ,'{{# } else { }}'
    ,'<button class="layui-btn layui-btn-danger" id="LAY_signin">今日签到</button>'
    ,'<span>可获得<cite>{{ d.change }}</cite>积分</span>'
  ,'{{# } }}'].join('')
  ,tplSigninDay = '已连续签到<cite>{{ d.keep }}</cite>天'
  ,tplMemberScore = '{{ d.score }} 积分'
  ...
  ,signRender = function(data){
    ...
    laytpl(tplMemberScore).render(data, function(html){
        elemMemberScore.html(html);
    });
  }

  ,elemSigninHelp = $('#LAY_signinHelp')
  ,elemSigninTop = $('#LAY_signinTop')
  ,elemMemberScore = $('#LAY_memberScore')
  ...
  //点赞
  $(".mine-zan").click(function() {
      var id = $(this).closest('li').data('id');
      fly.json('/user/zan', {id:id}, function(res){
          layer.msg(res.msg, {icon: 1,time: 1E3})
      });
  });

  //收藏
  $(".mine-fav").click(function() {
      var id = $(this).closest('li').data('id');
      fly.json('/user/fav', {id:id}, function(res){
          layer.msg(res.msg, {icon: 1,time: 1E3})
      });
  });
  exports('fly', fly);
